...
[![pod: v1.0.18](http://img.shields.io/badge/pod-v1.0.18-yellow.svg)](http://www.fantomfactory.org/pods/afBounce)
...
`BedClient` extends [ButterDish](http://repo.status302.com/doc/afButter/ButterDish.html) and so comes complete with convenience methods for calling RESTful services.
